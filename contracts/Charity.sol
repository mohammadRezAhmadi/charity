//SPDX-License-Identifier:MIT
    ...
    contract Charity{
        ...
        function assist(uint24 _id)public payable levelPending{
            ...
            require(voteStatus[msg.sender] == false , "This address has been voted");
            require(needy[_id].condition == true , "this address not true!");
            payable(address(this)).transfer(msg.value);
            voteStatus[msg.sender] = true;
            helpers[counterFunders] = helper(counterFunders , payable(msg.sender) , msg.value);
            CounterTotal++;
             needy[_id].vote++;
            counterFunders++;
        ...
        function payEnd(uint32 _id)public payable levelEnd{
